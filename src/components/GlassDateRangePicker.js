 ...
 * Implements the "Liquid Glass" design trend.
 ...
 * @param {function} onDayPress - Handles date selection logic.
 * @param {function} onClose - Closes the modal.
 * @param {function} onApply - Triggers the filter action.
 */
export default function GlassDateRangePicker({
  ...
  // MEMOIZATION: Calculates the green range strip efficiently
...
const styles = StyleSheet.create({
  ...
  glassContainer: {
    ...
    padding: 20,
    borderWidth: 1,
    borderColor: "rgba(255,255,255,0.15)", // Shiny border
    ...Platform.select({
      ios: {
        shadowColor: "#000",
